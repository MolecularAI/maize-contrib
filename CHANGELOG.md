...
### Feature
- Expanded tautomer options in LigPrep node

## Version 0.7.6

### Feature
- Diversity picker node for isomer collections

## Version 0.7.5

### Feature
- Construct molecule names for REINVENT from InChIKey if available

## Version 0.7.4

### Feature
- Node to tag isomer collections and SDFs with the InChIKey

## Version 0.7.3

### Feature
- Residue-specific IFPs with ProLIF

## Version 0.7.2

### Fix
- more consistent handling of isomer collection level scores

## Version 0.7.1

### Features
- added binary interaction fingerprint to ProLIF

## Version 0.7.0

### Changes
- extra flags for Gnina

## Version 0.6.9

### Changes
- extra flags for Vina, some are for version 1.2 but version flag controls that

## Version 0.6.8

### Changes
- allow multiple scores to be returned from ReinventExit

## Version 0.6.7

### Features
- added ProLIF node for protein-ligand fingerprints 

## Version 0.6.6

### Features
- added CamSol node for peptide solubility prediction

## Version 0.6.5

### Changes
- fix glide shape constraint handling 

## Version 0.6.4

### Changes
- initialize IC in LigPrep to consistentize output with smiles and IC input

## Version 0.6.3

### Features
- added PAMDS node and graph for peptide docking

## Version 0.6.2

### Features
- Added addh parameter to Smiles2Molecules
- Added per-conformer tagging for RMSD node

### Changes
- Removed smiles attribute assignment from Ligprep to avoid inconsistencies
- Glide core definition improvements
- Extended tag logging to conformers and isomers

### Fixes
- Cleaned up Schrodinger job running, ensured more likely killing of jobservers
- Fixed incorrect default override in Glide
- Added missing call to parent prepare method for Glide

## Version 0.6.1

### Features
- Added Gromacs RNA nodes (Pallavi)
- Added tag removal node
- Added pH parameter to OpenFE AHFE
- Added option to provide custom GNINA CNN models

### Fixes
- Add ROCS score as tag
...
### Changes
- Allowed `minimize` with GNINA

### Fixes
- Schrodinger jobservers are now stopped and killed in *all* situations

## Version 0.5.12

### Fixes
- Schrodinger jobserver cleanup is now performed in `run()`, reducing the chances of creating zombie processes

## Version 0.5.11

### Fixes
- Schrodinger jobserver interactions are now performed without PSI/J to reduce threading load

## Version 0.5.10

### Fixes
- Schrodinger jobserver forced shutdowns on node exit to avoid zombie processes

## Version 0.5.9

### Features
- Nodes for Oligo simulations
- Added Maize custom notebook explaining REINVENT GUI use
- Added tag renaming node
- Allowed more aggregation types for TagAgg
- Added initial AHFE workflow

### Changes
- Changed GNINA AL workflow defaults to always work
- Glide options can now be overwritten via constraints files

### Fixes
- Minor GNINA GPU fix
- Fixed Schrodinger job server directory cleanup failing on IO issues with the filesystem
- Fixed crash on invalid constraint option specification
- Fixed incompatible Glide constraint entries overwriting required Maize entries

## Version 0.5.8

### Features
- Added ADV / GNINA receptor preparation workflow
- Added alternative PDB output to Prepwizard

### Changes
- Improved Schrodinger logging calls
- Sensible default column name for `LoadSmilesAsIsomerCollection`

### Fixes
- Documentation fixes
- Updated meeko requirement for ADV nodes
