...
class Gypsum(Node):
    """
    Converts SMILES codes into a set of 3D molecules using Gypsum-DL [#ropp2019]_.
...
class TestSuiteGypsum:
    def test_Gypsum(self, temp_working_dir: Any, test_config: Any, example_smiles: Any) -> None:
