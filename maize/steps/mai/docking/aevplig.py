...
class AEVPLIG(Node):
    """
    Runs AEV-PLIG on a ligand pose.

    This is a scoring function that takes an existing ligand pose (obtained from
    e.g. docking) with the corresponding receptor conformation and outputs a predicted
    binding affinity. See the `full code <https://github.com/isakvals/AEV-PLIG>`_ and
    [#warren2024]_ for details.
