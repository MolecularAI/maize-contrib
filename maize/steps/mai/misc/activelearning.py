...
class ActiveLearningProgressSingle(Node):
    ...
    tags = {"chemistry", "saving", "active-learning"}
...
class AcquisitionFunction(Node, register=False):
    ...
    tags = {"chemistry", "utility", "active-learning"}
...
class FileCachedMol(Node):
    ...
    tags = {"chemistry", "utility", "active-learning", "saving", "loading", "scorer"}
...
class ALPooling(Graph):
    ...
    tags = {"chemistry", "active-learning"}
